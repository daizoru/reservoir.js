...
(function() {
  ...
  if (typeof require !== "undefined" && require !== null) {
    try {
      ...
      root.hash = function(obj) {
        return XXHash.hash(JSON.stringify(obj), root.seed);
      };
    } catch (_error) {}
  }
  ...
  root.Reservoir = (function() {
    ...
    */
    ...
    Reservoir.prototype.generate = function() {
      var category, i, id, key, nb_inputs, node, reservoirKeys;
      category = root.pick(Object.keys(this.library));
      key = root.pick(Object.keys(this.library[category]));
      reservoirKeys = this.list();
      nb_inputs = !reservoirKeys.length ? 0 : Number(category);
      node = {
        category: category,
        key: key,
        code: this.library[category][key],
        inputs: (function() {
          var _i, _results;
          _results = [];
